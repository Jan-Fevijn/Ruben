...
CREATE TABLE `product` (
  ...
  `bewaartijd` int(11) NOT NULL,
  `lade` int(11) NOT NULL,
  PRIMARY KEY (`idproduct`),
  UNIQUE KEY `aankoopDateProductNaam` (`productNaam`,`aankoopDate`) COMMENT 'je kan niet hetzelvde product op het zelvde moment toevoegen.'
