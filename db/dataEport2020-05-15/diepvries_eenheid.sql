...
CREATE TABLE `eenheid` (
  `ideenheid` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `eenheid`
--

LOCK TABLES `eenheid` WRITE;
/*!40000 ALTER TABLE `eenheid` DISABLE KEYS */;
/*!40000 ALTER TABLE `eenheid` ENABLE KEYS */;
UNLOCK TABLES;
