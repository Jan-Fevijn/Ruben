...
CREATE TABLE `recht` (
  `idrecht` int(11) NOT NULL AUTO_INCREMENT,
  `NaamRecht` varchar(45) NOT NULL,
  PRIMARY KEY (`idrecht`),
  UNIQUE KEY `NaamRecht_UNIQUE` (`NaamRecht`)
...
INSERT INTO `recht` (`idrecht`, `NaamRecht`) VALUES (3,'lezen'),(4,'schrijven');
